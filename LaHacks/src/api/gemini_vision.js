...
export async function getGeminiVisionRes(base64) {
  ...
  const prompt = "Give me a Javascript string array of the name of all the food ingredients found in the photo. Only return the Javascript string array in your response, do not return anything else.";
